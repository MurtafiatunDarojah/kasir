...
<body>
    ...
    <div class="modal-view">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo number_format($isi['harga_beli'] * $isi['jumlah']); ?>,-</td>
        ...
        <p>
            <br><b>Total Terjual :</b></br>
            <b><?php echo $jumlah; ?></b>
            <br><b>Modal : Rp.<?php echo number_format($modal); ?></b></br>
            <br> <b>Total : Rp.<?php echo number_format($bayar); ?></b></br>
            <br><b>Keuntungan :</b></br>
            <b> Rp.<?php echo number_format($bayar - $modal); ?></b>
        </p>
    </div>
</body>
